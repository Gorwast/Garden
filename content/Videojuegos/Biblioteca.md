...
Para la ps4 tengo una colección pequeña de juegos, la lista siguiente es mas que nada mis juegos en físico para dicha consola.
- The Last of Us: Remasterizado (Físico)
- God of War (Físico)
- Spider-man (Físico)
- Deus Ex: Mankind Divided (Físico)
- Kingdom Hearts III (Físico)
- Anthem (Físico, fue un regalo, lo se...)
- Injustice
- Death Stranding
- Fallout 4
